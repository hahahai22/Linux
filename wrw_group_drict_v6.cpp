...
__global__ void wrw_fp16_derict_group_v6(_Float16 *p_in,
                                          _Float16 *p_out,
                                          float *p_wei,
...
void run_wrw_fp16_derict_group_v6(_Float16 *d_Input_F16, _Float16 *d_OutputW_F16, float *d_FltW, const DATA_FORMAT_T *pDataFormat)
{
...
    //每个块里面有多少子块
    ...
    {
        prt_flat = 0;
        printf(">>> run_wrw_fp16_derict_group_v6\r\n");
    ...
    wrw_fp16_derict_group_v6<<<GridDim, BlockDim, dynamic_lds_size, 0>>>(d_Input_F16, d_OutputW_F16, d_FltW, KernelDataInfo);
}

void run_Transfer_float2float16_v6(_Float16 *dst, float *src, const DATA_FORMAT_T *pDataFormat)
{
    ...
    {
        prt_flat = 0;
        printf(">>> run_Transfer_float2float16_v6\r\n");
